...
def main():
    ...
    val_loader = torch.utils.data.DataLoader(dataset=val_dataset, batch_size=32, shuffle=True, num_workers=1)
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (inp, target) in enumerate(train_loader):
        ...
        prec3 = accuracy(output.data, target, topk=(1, 3))[
            -1]  ## res is of shape [2,B] representing top 1 and top k accuracy respectively
